...
public class OnionManager : MonoBehaviour
{
    ...
    [Header("Diced Onions Controller")]
    public DicedOnionsController dicedOnionsController;
    ...
    void Update()
    {
        ...
        if (onionController.isPlaced)
        {
            ...
            else if (knifeController.cutsMade >= 4)
            {
                ...
                dicedOnionsController.startPos = onionController.startPos + position;
                ...
                dicedOnionsController.startRot = rotation;
